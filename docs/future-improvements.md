...
Answer: Use a Blue/Green deployment strategy.


Why is it needed?

Answer: To deploy new application versions with minimal downtime.


How does it help the team or business?

Answer: Allows safer deployments and quick rollback if issues occur.


How would it be implemented?

Answer: Deploy the new version alongside the current version and switch traffic after successful testing.


What risk does it reduce?

Answer: Reduces deployment failures and application downtime.